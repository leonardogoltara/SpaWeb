...
using GoltaraSolutions.SpaWeb.Infra.Repository.DapperSQLServer.AgendaContext;
using GoltaraSolutions.SpaWeb.Infra.Repository.DapperSQLServer.ClienteContext;
using GoltaraSolutions.SpaWeb.Infra.Repository.DapperSQLServer.EmpresaContext;
using GoltaraSolutions.SpaWeb.Infra.Repository.DapperSQLServer.FuncionarioContext;
using GoltaraSolutions.SpaWeb.Infra.Repository.DapperSQLServer.ProdutoContext;
...
{
    public class RepositoryDapperSqlServerModule
    {
