...
{
    public class AtendimentoReportAgrupadoViewModel
    {
        public AtendimentoReportAgrupadoViewModel()
        {
        ...
        public virtual IEnumerable<AtendimentoReportAgrupadoView> Atendimentos { get; set; }
